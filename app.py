...
def actions_page():
    ...
    if score_total >= 100:
        ...
        notification = f"🔥 Plus que {100 - score_total} points pour Carrefour -15%"

    elif score_total >= 25:
        gift = "🎁 LIDL -10% (CODE: LIDL10)"
        notification = f"🎯 Plus que {75 - score_total} points pour -20%"

    else:
        notification = f"🚀 Plus que {25 - score_total} points pour débloquer Lidl -10%"
